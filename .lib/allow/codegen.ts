...
export const GENERATED_FILE = path.resolve(
  __dirname,
  "..",
  "generated",
  "allow.d.ts",
...
export function generateAllowTypes(contractsConfig: Record<string, any>): string {
  ...
  const out: string[] = [];
  out.push("// AUTO-GENERATED by `bun run setup`. Do not edit.");
...
function renderFunctionSignature(fragment: AbiFragment, indent: string): string {
...
export function writeGenerated(source: string): void {
